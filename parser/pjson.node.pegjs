...
expression
    = ws head:value ws si:expressionSign ws tail:expression ws {
        switch (si) {
            case '**':
                return head ** tail;
            case '+':
    ...
    / ws si:singleExpressionSign head:value ws {
        switch (si) {
            case '!':
                return !head;
            case '~':
...
singleExpressionSign
    = "!"
    / "~"

value
    = ws value:(false / null / true / object / array / number / string / file / get / import) ws {
        return value;
    }
    / brackets
...
member
    = ws name:name name_separator value:expression ws {
...
array
    = begin_array
        ...
        values:(
            head:expression
            tail:(value_separator v:expression { return v; })*
